...
class AddEditViewController: UITableViewController {
    ...
    let maxWidth = UIScreen.main.bounds.size.width - 140.0

    override func viewDidLoad() {
        super.viewDidLoad()
        nameLabel.text = "This is a garima"
        
        print(nameLabel.frame.size.width)
        print(nameLabel.intrinsicContentSize.width)
